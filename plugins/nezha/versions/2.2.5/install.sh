...
# cd /www/server/mdserver-web/plugins/nezha && bash install.sh install 2.2.5
# cd /Users/midoks/Desktop/mwdev/server/mdserver-web/plugins/nezha && bash install.sh install 2.2.5
