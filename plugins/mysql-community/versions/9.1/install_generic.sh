...
# cd /www/server/mdserver-web/plugins/mysql-community && bash install.sh install 9.1
# cd /www/server/mdserver-web && python3 /www/server/mdserver-web/plugins/mysql-community/index.py start 9.1
COMMUNITY_INSTALL()
{
