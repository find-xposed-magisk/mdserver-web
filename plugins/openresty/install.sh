...
# cd /Users/midoks/Desktop/mwdev/server/mdserver-web/plugins/openresty && bash install.sh upgrade 1.31.1
...
# cd /www/server/mdserver-web/plugins/openresty && bash install.sh upgrade 1.31.1
