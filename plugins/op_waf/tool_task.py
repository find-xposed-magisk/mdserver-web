...
''' % (mw_dir, name, getServerDir(), getPluginDir())
    ...
    cmd += 'echo "cd $mw_dir && . bin/activate && python3 $script_path/tool_task.py run >> $logs_file 2>&1"' + "\n"
    cmd += 'cd $mw_dir && . bin/activate && python3 $script_path/tool_task.py run >> $logs_file 2>&1' + "\n"
